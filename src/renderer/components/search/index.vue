    ...
    <div class="right-controls">
      ...
      <section v-if="type === 'replace'" class="replace">
        ...
        <div class="button-group">
          ...
          <AppTooltip class="item" content="Replace Single" side="top" :delay="1000">
...
export default {
  ...
  created() {
    ...
    useEventListener(document, 'keyup', this.docKeyup)
  },

  mounted() {
    onClickOutside(this.$refs.searchBar as HTMLElement, () => {
