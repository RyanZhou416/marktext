# Debugging (Electron Era - Archived)

> **This document is archived.** It describes debugging techniques for the Electron-based version. For the current Tauri debugging guide, see [DEBUGGING.md](../DEBUGGING.md).
