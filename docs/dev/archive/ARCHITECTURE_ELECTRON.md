# Project Architecture (Electron Era - Archived)

> **This document is archived.** It describes the Electron-based architecture that was used before the migration to Tauri 2.0. For the current architecture, see [ARCHITECTURE.md](../ARCHITECTURE.md).
