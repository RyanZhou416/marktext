# Inter-Process Communication - IPC (Electron Era - Archived)

> **This document is archived.** It describes Electron's IPC model (ipcMain/ipcRenderer). For the current Tauri IPC documentation, see [IPC.md](../code/IPC.md).
